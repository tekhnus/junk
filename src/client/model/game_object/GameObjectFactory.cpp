...
std::unordered_map<int, std::function<GameObject*()> >
    GameObjectFactory::gameObjectCreator;
Logger GameObjectFactory::logger("CLIENT_GAME_OBJECT_FACTORY",
                                 "client_model.log", true);
...
GameObject* GameObjectFactory::create(
    const GameObjectType::type& gameObjectType) {
